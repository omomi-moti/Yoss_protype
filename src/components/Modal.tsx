...
export default function Modal({ onClose, labelledBy, children }: {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-yoss-dark/40 p-4 sm:p-8"
    ...
    >
      <div
        ...
        className="w-full max-w-3xl bg-[#FAFAFA] rounded-2xl shadow-xl"
      >
        {children}
      </div>
    </div>
