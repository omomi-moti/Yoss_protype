...
export default function MeetingScreeningTab({ student }: { student: Student }) {
  ...
  return (
    <div className="h-full flex flex-col gap-3 px-6 py-4 min-h-0">
      ...
      <div className="flex-1 min-h-0 grid grid-cols-[1.9fr_1fr] gap-5">
        <div className="flex flex-col gap-2 min-h-0">
          ...
          <div className="flex-1 min-h-0 overflow-y-auto border border-gray-200 rounded-xl">
            <div className="grid grid-cols-[1fr_5rem_6rem] bg-gray-50 border-b border-gray-100 text-xs text-gray-500 sticky top-0">
        ...
        <div className="flex flex-col gap-2 min-h-0 overflow-y-auto pr-1">
          <h3 className="shrink-0 text-sm font-bold text-yoss-dark">スクリーニング会議での記録</h3>
