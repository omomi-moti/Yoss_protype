...
// 軸①：自治体が登録する対応可能な支援（YOSS 8領域）
export const defaultResources: SupportResource[] = [
  // 学校適応
  { id: 'r14', name: '適応指導教室', category: '学校適応', description: '不登校児童生徒の学校復帰を支援', targetGrades: '小1〜中3', cost: '無料', capacity: '各20名', contact: '教育委員会 指導課', enabled: true },
  ...
  // 家庭状況
  { id: 'r9', name: '保護者相談窓口', category: '家庭状況', description: '子育ての悩み全般に対応', targetGrades: '-', cost: '無料', capacity: '予約制', contact: 'こども家庭センター', enabled: true },
  { id: 'r10', name: '家庭訪問支援', category: '家庭状況', description: '養育支援訪問事業', targetGrades: '-', cost: '無料', capacity: '月10件程度', contact: 'こども家庭センター', enabled: true },
  { id: 'r11', name: '保護者プログラム', category: '家庭状況', description: 'ペアレントトレーニング（全6回）', targetGrades: '-', cost: '無料', capacity: '各回10名', contact: 'こども家庭センター', enabled: false },

  // 発達
  { id: 'r12', name: '発達相談', category: '発達', description: '発達に関する専門相談', targetGrades: '全学年', cost: '無料', capacity: '月12件', contact: '保健センター', enabled: true },

  // 健康
  { id: 'r2', name: '医療費助成', category: '健康', description: '18歳以下の医療費自己負担分を助成', targetGrades: '全学年', cost: '無料', capacity: '制限なし', contact: '市民課 子育て支援係', enabled: true },

  // 経済
  { id: 'r1', name: '就学援助', category: '経済', description: '学用品費・給食費等の援助', targetGrades: '小1〜中3', cost: '無料', capacity: '所得基準あり', contact: '教育委員会 学事課', enabled: true },
  { id: 'r3', name: '給付型奨学金', category: '経済', description: '返済不要の奨学金', targetGrades: '中3', cost: '無料', capacity: '年間20名', contact: '教育委員会', enabled: false },

  // 福祉
  { id: 'r13', name: 'スクールカウンセラー連携', category: '福祉', description: 'SC との連携による心理支援', targetGrades: '全学年', cost: '無料', capacity: '各校週1回', contact: '教育委員会', enabled: true },

  // 地域情報
  { id: 'r4', name: '子ども食堂', category: '地域情報', description: '無料または低額の食事提供と居場所', targetGrades: '全学年', cost: '無料〜100円', capacity: '各30名程度', contact: '社会福祉協議会', enabled: true },
  { id: 'r5', name: '放課後子ども教室', category: '地域情報', description: '放課後の安全な居場所と体験活動', targetGrades: '小1〜小6', cost: '無料', capacity: '各校40名', contact: '生涯学習課', enabled: true },
  { id: 'r6', name: 'フリースクール連携', category: '地域情報', description: '不登校児童生徒の学びの場', targetGrades: '小1〜中3', cost: '月額5,000円〜', capacity: '15名', contact: 'こども家庭センター', enabled: false },
];
