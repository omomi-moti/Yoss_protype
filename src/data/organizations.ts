...
const seeds: OrganizationSeed[] = [
  {
    ...
    supports: [
      { id: 'r4', name: '子ども食堂', category: '地域情報', description: '無料または低額の食事提供と居場所', targetGrades: '全学年', cost: '無料〜100円', capacity: '各30名程度', enabled: true },
      { id: 's-pantry', name: 'フードパントリー', category: '経済', description: '食料品の無償配布（月2回）', targetGrades: '-', cost: '無料', capacity: '月40世帯', enabled: true },
    ],
    reviews: [
      {
        schoolName: '○○小学校',
  ...
  },
  {
    ...
    supports: [
      { id: 'r7', name: '学習支援教室', category: '学習', description: '大学生ボランティアによる学習支援', targetGrades: '小4〜中3', cost: '無料', capacity: '各回15名', enabled: true },
      { id: 'r5', name: '放課後子ども教室', category: '地域情報', description: '放課後の安全な居場所と体験活動', targetGrades: '小1〜小6', cost: '無料', capacity: '各校40名', enabled: true },
    ],
    reviews: [
      {
        schoolName: '△△小学校',
  ...
  },
  {
    ...
    supports: [
      { id: 'r9', name: '保護者相談窓口', category: '家庭状況', description: '子育ての悩み全般に対応（LINE相談は24時間受付）', targetGrades: '-', cost: '無料', capacity: '予約制', enabled: true },
      { id: 'r10', name: '家庭訪問支援', category: '家庭状況', description: '養育支援訪問事業', targetGrades: '-', cost: '無料', capacity: '月10件程度', enabled: true },
      { id: 's-ycarer', name: 'ヤングケアラー相談', category: '福祉', description: '専用相談窓口・ヘルパー派遣制度の案内', targetGrades: '全学年', cost: '無料', capacity: '随時', enabled: true },
      { id: 'r11', name: '保護者プログラム', category: '家庭状況', description: 'ペアレントトレーニング（全6回）', targetGrades: '-', cost: '無料', capacity: '各回10名', enabled: false },
    ],
    reviews: [
      {
        schoolName: '□□中学校',
  ...
  },
  {
    ...
    supports: [
      { id: 'r6', name: 'フリースクール通所', category: '学校適応', description: '不登校児童生徒の学びの場（出席認定対応）', targetGrades: '小1〜中3', cost: '月額5,000円〜', capacity: '15名', enabled: true },
      { id: 's-online', name: 'オンライン学習サポート', category: '学習', description: '通所が難しい子ども向けの在宅学習支援', targetGrades: '小4〜中3', cost: '月額3,000円', capacity: '10名', enabled: false },
    ],
    reviews: [
      {
        schoolName: '○○小学校',
  ...
  },
  {
    ...
    supports: [
      { id: 'r8', name: '日本語指導教室', category: '学習', description: '外国にルーツのある児童生徒向け', targetGrades: '全学年', cost: '無料', capacity: '10名', enabled: true },
    ],
    reviews: [],
    isMine: false,
  },
  {
    ...
    supports: [
      { id: 'r1', name: '就学援助', category: '経済', description: '学用品費・給食費等の援助（オンライン申請可）', targetGrades: '小1〜中3', cost: '無料', capacity: '所得基準あり', enabled: true },
      { id: 'r14', name: '適応指導教室', category: '学校適応', description: '不登校児童生徒の学校復帰を支援', targetGrades: '小1〜中3', cost: '無料', capacity: '各20名', enabled: true },
      { id: 'r13', name: 'スクールカウンセラー連携', category: '福祉', description: 'SC・SSWとの連携による心理／福祉支援', targetGrades: '全学年', cost: '無料', capacity: '各校週1回', enabled: true },
      { id: 'r3', name: '給付型奨学金', category: '経済', description: '返済不要の奨学金', targetGrades: '中3', cost: '無料', capacity: '年間20名', enabled: false },
    ],
    reviews: [
      {
        schoolName: '○○小学校',
  ...
  },
  {
    ...
    supports: [
      { id: 'r12', name: '発達相談', category: '発達', description: '発達に関する専門相談（医師同席枠あり）', targetGrades: '全学年', cost: '無料', capacity: '月12件', enabled: true },
      { id: 'r2', name: '医療費助成', category: '健康', description: '18歳以下の医療費自己負担分を助成', targetGrades: '全学年', cost: '無料', capacity: '制限なし', enabled: true },
    ],
    reviews: [],
    isMine: false,
  },
  {
    ...
    supports: [
      { id: 's-seat', name: '無償学習席の提供', category: '学習', description: '学習塾の空き枠を無償開放（学校推薦制）', targetGrades: '小5〜中3', cost: '無料', capacity: '各教室5名', enabled: true },
    ],
    reviews: [],
    isMine: false,
  },
